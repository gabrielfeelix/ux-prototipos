 ...
 *
 * CAPAS: `cover` é opcional de propósito. O caminho de uma capa na Wikipedia é
 * um hash que não dá pra deduzir, e 60 links quebrados seriam pior que nenhum.
 * Sem `cover`, o card desenha o nome sobre as duas cores da banda — ver
 * BandTile. Para ligar a capa de uma banda, basta pôr o arquivo em
 * `public/bandas/{id}.jpg` e apontar `cover` para ele. */
...
export const BANDS: Band[] = [
  /* ——— rock ——— */
  { id: "ramones", name: "Ramones", genero: "rock", subgenero: "punk",
  ...
  { id: "pink-floyd", name: "Pink Floyd", alias: ["floyd"], genero: "rock", subgenero: "progressivo",
  ...
  { id: "legiao", name: "Legião Urbana", alias: ["legiao", "renato russo"], genero: "rock", subgenero: "rock brasileiro",
  ...
  { id: "titas", name: "Titãs", alias: ["titas"], genero: "rock", subgenero: "rock brasileiro",
    bg1: "#B3231F", bg2: "#151515", tag: "Rock de porão",
    som: { corda: "aco", captacao: "humbucker", nivel: "medio", ataque: "agressivo" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "capital", name: "Capital Inicial", genero: "rock", subgenero: "rock brasileiro",
    bg1: "#2A2A2A", bg2: "#D4622A", tag: "Refrão de estádio",
    som: { corda: "aco", captacao: "humbucker", nivel: "medio", ataque: "agressivo" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "strokes", name: "The Strokes", alias: ["strokes"], genero: "rock", subgenero: "indie",
    bg1: "#171717", bg2: "#C43B2E", tag: "Indie seco",
    som: { corda: "aco", captacao: "single", nivel: "medio", ataque: "brilhante" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "arctic", name: "Arctic Monkeys", alias: ["arctic"], genero: "rock", subgenero: "indie",
    bg1: "#101820", bg2: "#8A8F98", tag: "Riff grave",
    som: { corda: "aco", captacao: "humbucker", nivel: "medio", ataque: "agressivo" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "fresno", name: "Fresno", genero: "rock", subgenero: "emo",
    bg1: "#1B1B2F", bg2: "#E0446D", tag: "Emo brasileiro",
    som: { corda: "aco", captacao: "humbucker", nivel: "facil", ataque: "agressivo" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "charlie-brown", name: "Charlie Brown Jr.", alias: ["cbjr", "chorao"], genero: "rock", subgenero: "rap rock",
    bg1: "#0F3D2E", bg2: "#F2B705", tag: "Skate e peso",
    som: { corda: "aco", captacao: "humbucker", nivel: "medio", ataque: "agressivo" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "nirvana", name: "Nirvana", genero: "rock", subgenero: "grunge",
    bg1: "#1A1A1A", bg2: "#D9C441", tag: "Grunge sujo",
    som: { corda: "aco", captacao: "humbucker", nivel: "facil", ataque: "agressivo" },
    instrumentos: ["guitarra", "baixo", "bateria"] },
  { id: "queen", name: "Queen", genero: "rock", subgenero: "rock clássico",
  ...
  { id: "led", name: "Led Zeppelin", alias: ["led zepelin"], genero: "rock", subgenero: "rock clássico",
  ...
  { id: "tim-maia", name: "Tim Maia", genero: "mpb", subgenero: "soul",
    bg1: "#4A1C1C", bg2: "#E8B04B", tag: "Groove e sopro",
    som: { corda: "aco", captacao: "single", nivel: "medio", ataque: "brilhante" },
    instrumentos: ["baixo", "teclado", "sopro", "guitarra"] },

  /* ——— gospel ——— */
  { id: "hillsong", name: "Hillsong", genero: "gospel", subgenero: "worship",
    bg1: "#101B2D", bg2: "#3E7CB1", tag: "Worship de palco",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "guitarra", "teclado", "bateria"] },
  { id: "gabriela-rocha", name: "Gabriela Rocha", genero: "gospel", subgenero: "worship br",
    bg1: "#2B1B3D", bg2: "#C9A227", tag: "Voz e congregação",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "teclado"] },
  { id: "fernandinho", name: "Fernandinho", genero: "gospel", subgenero: "worship br",
    bg1: "#14302B", bg2: "#D9A441", tag: "Louvor congregacional",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "guitarra", "teclado"] },
  { id: "diante-do-trono", name: "Diante do Trono", alias: ["ddt", "ana paula valadao"], genero: "gospel", subgenero: "worship br",
    bg1: "#1B2A4A", bg2: "#E4C16F", tag: "Igreja cheia",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "teclado", "bateria"] },
  { id: "morada", name: "Morada", genero: "gospel", subgenero: "worship indie",
    bg1: "#23313A", bg2: "#A8C0A0", tag: "Arranjo enxuto",
    som: { corda: "aco", captacao: "passiva", nivel: "medio", ataque: "suave" },
    instrumentos: ["violao", "guitarra", "teclado"] },
  { id: "isaias-saad", name: "Isaías Saad", genero: "gospel", subgenero: "worship br",
    bg1: "#1A1A2E", bg2: "#C87800", tag: "Ministração longa",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "suave" },
    instrumentos: ["violao", "teclado"] },

  /* ——— sertanejo ——— */
  { id: "chitaozinho", name: "Chitãozinho & Xororó", alias: ["chitaozinho"], genero: "sertanejo", subgenero: "sertanejo raiz",
  ...
  { id: "almir-sater", name: "Almir Sater", genero: "sertanejo", subgenero: "viola caipira",
    bg1: "#2F3A1F", bg2: "#C9A227", tag: "Viola de dez cordas",
    som: { corda: "aco", captacao: "passiva", nivel: "dificil", ataque: "brilhante" },
    instrumentos: ["viola", "violao"] },
  { id: "marilia", name: "Marília Mendonça", genero: "sertanejo", subgenero: "feminejo",
    bg1: "#2A1B2E", bg2: "#E0446D", tag: "Sofrência",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "teclado"] },
  { id: "jorge-mateus", name: "Jorge & Mateus", genero: "sertanejo", subgenero: "sertanejo universitário",
    bg1: "#1B2A3A", bg2: "#E8C34A", tag: "Universitário",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "guitarra", "teclado"] },
  { id: "henrique-juliano", name: "Henrique & Juliano", genero: "sertanejo", subgenero: "sertanejo moderno",
    bg1: "#22303C", bg2: "#D98F4E", tag: "Arena e PA",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "guitarra", "bateria"] },
  { id: "michel-telo", name: "Michel Teló", genero: "sertanejo", subgenero: "sertanejo pop",
    bg1: "#2E2233", bg2: "#F2A65A", tag: "Sanfona e refrão",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "teclado"] },

  /* ——— samba ——— */
  { id: "cartola", name: "Cartola", genero: "samba", subgenero: "samba de raiz",
    bg1: "#EDE4D3", bg2: "#2E5E3E", tag: "Samba canção",
    som: { corda: "nylon", captacao: "nenhuma", nivel: "medio", ataque: "suave" },
    instrumentos: ["violao", "ukulele"] },
  { id: "paulinho-viola", name: "Paulinho da Viola", genero: "samba", subgenero: "samba de raiz",
    bg1: "#E8DFCB", bg2: "#1F4E5F", tag: "Violão de sete",
    som: { corda: "nylon", captacao: "nenhuma", nivel: "dificil", ataque: "suave" },
    instrumentos: ["violao"] },
  { id: "zeca", name: "Zeca Pagodinho", alias: ["zeca"], genero: "samba", subgenero: "pagode",
    bg1: "#1E4023", bg2: "#E0B04B", tag: "Roda de samba",
    som: { corda: "nylon", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "ukulele"] },
  { id: "fundo-de-quintal", name: "Fundo de Quintal", genero: "samba", subgenero: "pagode",
    bg1: "#2B3A2B", bg2: "#D9B25F", tag: "Cavaco e tantã",
    som: { corda: "aco", captacao: "passiva", nivel: "medio", ataque: "brilhante" },
    instrumentos: ["ukulele", "violao"] },
  { id: "jorge-aragao", name: "Jorge Aragão", genero: "samba", subgenero: "samba",
    bg1: "#33241B", bg2: "#C87800", tag: "Partido alto",
    som: { corda: "nylon", captacao: "passiva", nivel: "medio", ataque: "suave" },
    instrumentos: ["violao", "ukulele"] },

  /* ——— folk ——— */
  { id: "fleet-foxes", name: "Fleet Foxes", genero: "folk", subgenero: "folk barroco",
    bg1: "#E3E0D3", bg2: "#4A6B52", tag: "Voz em camadas",
    som: { corda: "aco", captacao: "nenhuma", nivel: "medio", ataque: "suave" },
    instrumentos: ["violao"] },
  { id: "mumford", name: "Mumford & Sons", alias: ["mumford"], genero: "folk", subgenero: "folk rock",
  ...
  { id: "bon-iver", name: "Bon Iver", genero: "folk", subgenero: "folk intimista",
    bg1: "#1C2228", bg2: "#8FA6A6", tag: "Quarto e reverb",
    som: { corda: "aco", captacao: "passiva", nivel: "medio", ataque: "suave" },
    instrumentos: ["violao", "teclado"] },
  { id: "bob-dylan", name: "Bob Dylan", alias: ["dylan"], genero: "folk", subgenero: "folk clássico",
  ...
  { id: "tiago-iorc", name: "Tiago Iorc", genero: "folk", subgenero: "folk br",
    bg1: "#EDE6DA", bg2: "#A8582E", tag: "Voz e dedilhado",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "suave" },
    instrumentos: ["violao"] },

  /* ——— blues e jazz ——— */
  { id: "bb-king", name: "B.B. King", genero: "blues", subgenero: "blues elétrico",
    bg1: "#1A1208", bg2: "#C9A227", tag: "Bend e vibrato",
    som: { corda: "aco", captacao: "humbucker", nivel: "dificil", ataque: "brilhante" },
    instrumentos: ["guitarra"] },
  { id: "srv", name: "Stevie Ray Vaughan", alias: ["srv", "stevie"], genero: "blues", subgenero: "blues texano",
    bg1: "#22160F", bg2: "#B5472A", tag: "Strato brava",
    som: { corda: "aco", captacao: "single", nivel: "dificil", ataque: "agressivo" },
    instrumentos: ["guitarra"] },
  { id: "wes", name: "Wes Montgomery", alias: ["wes"], genero: "blues", subgenero: "jazz",
    bg1: "#12212B", bg2: "#C08A3E", tag: "Polegar e oitava",
    som: { corda: "aco", captacao: "humbucker", nivel: "dificil", ataque: "suave" },
    instrumentos: ["guitarra"] },
  { id: "miles", name: "Miles Davis", genero: "blues", subgenero: "jazz modal",
  ...
  { id: "baden", name: "Baden Powell", genero: "blues", subgenero: "samba jazz",
    bg1: "#1E2A22", bg2: "#D9A441", tag: "Nylon virtuoso",
    som: { corda: "nylon", captacao: "nenhuma", nivel: "dificil", ataque: "agressivo" },
    instrumentos: ["violao"] },

  /* ——— pop ——— */
  { id: "taylor", name: "Taylor Swift", alias: ["taylor"], genero: "pop", subgenero: "pop folk",
    bg1: "#F0E4E9", bg2: "#6E5A7A", tag: "Violão e refrão",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "brilhante" },
    instrumentos: ["violao", "teclado"] },
  { id: "ed-sheeran", name: "Ed Sheeran", alias: ["sheeran"], genero: "pop", subgenero: "pop acústico",
    bg1: "#F2E8DC", bg2: "#C0442E", tag: "Loop e percussão no tampo",
    som: { corda: "aco", captacao: "passiva", nivel: "medio", ataque: "agressivo" },
    instrumentos: ["violao"] },
  { id: "anavitoria", name: "Anavitória", genero: "pop", subgenero: "pop br",
    bg1: "#F3ECE0", bg2: "#8C9E6E", tag: "Dueto e violão",
    som: { corda: "nylon", captacao: "passiva", nivel: "facil", ataque: "suave" },
    instrumentos: ["violao"] },
  { id: "melim", name: "Melim", genero: "pop", subgenero: "pop br",
    bg1: "#E9EDF0", bg2: "#3E7CB1", tag: "Leve e solar",
    som: { corda: "nylon", captacao: "passiva", nivel: "facil", ataque: "suave" },
    instrumentos: ["violao", "ukulele"] },
  { id: "jack-johnson", name: "Jack Johnson", genero: "pop", subgenero: "pop praia",
    bg1: "#E7E2CF", bg2: "#4E7A54", tag: "Praia e batida solta",
    som: { corda: "aco", captacao: "passiva", nivel: "facil", ataque: "suave" },
    instrumentos: ["violao", "ukulele"] },
  { id: "coldplay", name: "Coldplay", genero: "pop", subgenero: "pop rock",
